...
## Arquivo-fonte
- oceanografia/scripts/splot_tsm_serie_tendencia.py

## O que faz
- Gera painel combinado de serie temporal e tendencia da TSM.
...
## Comando pronto
```powershell
python "oceanografia/scripts/splot_tsm_serie_tendencia.py"
```
