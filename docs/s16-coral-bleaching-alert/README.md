# Script: s16_coral_bleaching_alert.py

## Arquivo-fonte
- oceanografia/scripts/s16_coral_bleaching_alert.py

## O que faz
- Calcula indicador de alerta de branqueamento de corais.
...
## Comando pronto
```powershell
python "oceanografia/scripts/s16_coral_bleaching_alert.py"
```
