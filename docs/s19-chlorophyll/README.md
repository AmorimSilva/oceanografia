# Script: s19_chlorophyll.py

## Arquivo-fonte
- oceanografia/scripts/s19_chlorophyll.py

## O que faz
- Gera mapa de clorofila superficial do oceano.
...
## Comando pronto
```powershell
python "oceanografia/scripts/s19_chlorophyll.py"
```
